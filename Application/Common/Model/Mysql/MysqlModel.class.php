<?php
	...
	*/
    ...
    /**
     * 这个类解决Thinkphp 不能执行 结构性语句而加入的
     */

	class MysqlModel extends ezSQLcore
	{
		var $dbuser = false;
		...
		*/
		function __construct($dbuser='', $dbpassword='', $dbname='', $dbhost='', $encoding='')
		{
			$this->dbuser = $dbuser?:C('DB_USER');
